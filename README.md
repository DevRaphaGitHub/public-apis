...
| [GitHub GraphQL](https://docs.github.com/en/free-pro-team@latest/graphql) | New API GitHub GraphQL, create precise and flexible queries for the data | `OAuth` | Yes | Yes |
